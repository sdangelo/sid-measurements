...
The measure.bas program in the [A-SID repo](https://github.com/Orastron/asid) was used to setup the filter and the audio I/O was taken from the A/V port using the DIY breakout connector described [here](https://clack.digital/asid#c64-instructions).
...
IRs can be extracted using the getIR.m GNU Octave script in the [A-SID repo](https://github.com/Orastron/asid).
